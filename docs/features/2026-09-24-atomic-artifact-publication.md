...
default: stage within the destination filesystem and publish with an exclusive
...
1. Define supported filesystems and completion-manifest interface.
...
manifest for every incomplete bundle. Distinguish crash durability from visibility.
